...
Page({
  ...
  onShow: function () {
    ...
    if (currPage.data.mydata != null) {
      ...
      this.setData({
        // dcode: wx.getStorageSync('dcode'),
        // useCoupon: wx.getStorageSync('hasCoupon'),
        // truePayNumber: wx.getStorageSync('paymoney'),
        // backmess: wx.getStorageSync('backmess'),
    ...
    // var counameqq = wx.getStorageSync('couname')
    // counameqq = this.data.backmessa
    this.setData({
      skinStyle: app.globalData.skin,
      hairbg: app.globalData.hairbg,
      educationbg: app.globalData.educationbg
  ...
  chooseCoupon: util.throttle(function (e) {
    ...
    console.log(this.data.ticketids, "ticketids")
