...
Page({
  ...
  onLoad: function (options) {
    console.log(options,"options门店")
    var couid = options.couid
    var couname = options.id
    var ticketids = options.ticketids
    var tickettype = options.tickettype
    var ucid = options.ucid
  ...
  */
  ...
  goDetail:function(e){
    console.log(e,"e")
    wx.navigateTo({
      url: '../../pages/pays/pays?id=' + this.data.couname + "&ticketids=" + this.data.ticketids + "&tickettype=" + this.data.tickettype + "&ucid=" + this.data.ucid + "&shopid=" + e.currentTarget.dataset.shopid + "&couid=" + this.data.couid 
    })
  },
  /**
* 生命周期函数--监听页面初次渲染完成
